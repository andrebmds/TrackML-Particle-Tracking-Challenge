...
# print(dna_df.iloc[1])
# [print(dna_inside) for dna_inside in dna_df]
browser = pd.DataFrame(dna_df['deviceSignature'])
print(browser)
# print(dna['deviceSignature'])

def create_a_sample_file():
	# columns_names = ['collector', 'collectorVersion', 'browser', ]
